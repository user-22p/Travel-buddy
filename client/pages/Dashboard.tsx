  ...
  const travelBuddies = [
    {
      ...
      budget: "₹2000-3000",
      compatibility: 95,
      bio: "Love exploring local food scenes and hidden gems! Looking for someone to share authentic cultural experiences.",
      interests: ["Food", "Culture", "Photography", "Museums"],
    ...
    },
    {
      ...
      location: "Austin, TX",
      destination: "Iceland",
      dates: "April 10-20, 2024",
      budget: "₹1500-2500",
      compatibility: 87,
      bio: "Adventure enthusiast seeking hiking companion for Iceland's stunning landscapes and Northern Lights.",
      interests: ["Hiking", "Photography", "Nature", "Adventure"],
      avatar: "/api/placeholder/64/64",
      isOnline: false
    },
    {
      ...
      budget: "₹1000-2000",
      compatibility: 92,
      bio: "Backpacker looking for travel buddy to explore Thailand's beaches, temples, and street food.",
      interests: ["Beaches", "Culture", "Food", "Backpacking"],
      avatar: "/api/placeholder/64/64",
      isOnline: true
    },
    {
      ...
      budget: "₹2000-3000",
      compatibility: 89,
      bio: "History buff planning to hike Machu Picchu and explore ancient Incan sites.",
      interests: ["History", "Hiking", "Culture", "Adventure"],
      avatar: "/api/placeholder/64/64",
      isOnline: true
    }
  ];
